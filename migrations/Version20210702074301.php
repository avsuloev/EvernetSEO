 ...
 */
final class Version20210702074301 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE etxt_multitasking (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', multitone_mode INT DEFAULT NULL, is_multitask INT DEFAULT NULL, multitasks_counted INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE etxt_task_text_restraints (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', unique_score INT DEFAULT NULL, place_on_site INT DEFAULT NULL, space_count_mode INT DEFAULT NULL, task_size_in_chars INT DEFAULT NULL, require90_percent_completion INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etxt_task_type (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', task_type_id INT DEFAULT NULL, task_subtype_id INT DEFAULT NULL, task_category_id INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE etxt_tasks_author_restraints (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', require_skill_check INT DEFAULT NULL, whitelist_mode INT DEFAULT NULL, whitelist_id INT DEFAULT NULL, notify_whitelisted INT DEFAULT NULL, is_certified_only INT DEFAULT NULL, is_graduated_only INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE keyword (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', keyword_group_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:ulid)\', name VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, is_approved TINYINT(1) NOT NULL, position INT DEFAULT NULL, frequency INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5A93713B6F3F1416 (keyword_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE project (id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', client_id BINARY(16) NOT NULL COMMENT \'(DC2Type:ulid)\', tv_id VARCHAR(255) DEFAULT NULL, ym_id VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) NOT NULL, url VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_2FB3D0EE19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE keyword_group_keyword_group ADD CONSTRAINT FK_D5AD91C567CBDBC9 FOREIGN KEY (keyword_group_source) REFERENCES keyword_group (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE keyword_group_keyword_group ADD CONSTRAINT FK_D5AD91C57E2E8B46 FOREIGN KEY (keyword_group_target) REFERENCES keyword_group (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE keyword_group_keyword_group DROP FOREIGN KEY FK_D5AD91C567CBDBC9');
        $this->addSql('ALTER TABLE keyword_group_keyword_group DROP FOREIGN KEY FK_D5AD91C57E2E8B46');
